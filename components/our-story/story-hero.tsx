    ...
    <section className="relative w-full min-h-screen pt-32 pb-20 flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center space-y-8 animate-slide-in-up">
          ...
          <p className="text-xl md:text-2xl text-[var(--color-text-secondary)] font-light leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="pt-12 animate-bounce">
            <div className="w-6 h-10 border-2 border-[var(--color-text-secondary)] rounded-full flex items-start justify-center p-2 mx-auto">
